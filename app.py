...
#  
BASE_PROMPT ="""
Given the video title, the tags and the transcript of the video this program will generate a prompt to create an
attractive thumbnail related to the video content.
...
Prompt: A man showing his career path  in a map, showing the technologies he learn with it, like excel, SQL and python.
--
...
Prompt: A woman on her office, showing her desk, with one macbook pro at the background and a PC in first plane.
--
